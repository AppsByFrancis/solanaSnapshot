    ...
    return(
            <div className="flex w-full justify-center items-center">
                <div className="flex w-full flex-col items-center justify-center text-center">
                    <h1 className="text-white text-3xl mb-6 text-left">Look up NFT collection</h1>
                    <div className="searchBar">
                        ...
                        <button id="searchQuerySubmit" onClick={() => onChildClick(searchInput)} type="submit" name="searchQuerySubmit">
